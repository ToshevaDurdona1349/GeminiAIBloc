...
import 'package:gemini_proekt/presentation/bloc/home_bloc/home_state.dart';
import 'package:hive/hive.dart';
import 'package:speech_to_text/speech_recognition_result.dart';
import 'package:speech_to_text/speech_to_text.dart';
import '../../../core/services/log_service.dart';
import '../../../core/services/utils_service.dart';
import '../../../data/datasourcase/loocal/hive_service.dart';
import '../../../data/models/message_model.dart';
import '../../../data/repositories/gemini_talk_repository_impl.dart';
import '../../../domain/usecases/gemini_text_and_image.dart';
...
class HomeBloc extends Bloc<HomeEvent, HomeState> {
  HomeBloc() : super(InitialState()) {
    ...
    // });
    on<SpeakTTSEvent>((event, emit) {
      // Call TTS function here
      _speakTTS(event.message);
      emit(SpeakingTTSState());
    });
  }
  void _speakTTS(String message) {
